...
def initialize_model(initial_liquidity, initial_tradevolume, initial_fee_assets, initial_fee_LRNA):
    ...
    action_dict = {
        'sell_r2_for_r1': {'token_buy': 'R1', 'token_sell': 'R2', 'amount_sell': initial_tradevolume,
                           'action_id': 'Trade', 'agent_id': 'Trader'},
        'sell_r1_for_r2': {'token_sell': 'R1', 'token_buy': 'R2', 'amount_sell': initial_tradevolume,
                           'action_id': 'Trade', 'agent_id': 'Trader'}
    }
    ...
    initial_values = {
        'token_list': ['R1', 'R2'],
        'R': [initial_liquidity, 1500000],
        'P': [2, 2 / 3],
        'fee_assets': initial_fee_assets,
        'fee_LRNA': initial_fee_LRNA
    }
