...
def liquidate_all(pool_id: str):
    def strategy(state: GlobalState, agent_id: str) -> GlobalState:
        ...
        for cdp in cdps:
            if cdp.in_liquidation:
                ...
                if omnipool.price(omnipool, collateral_asset, debt_asset) < (1 + penalty) * (cdp.debt_amt / cdp.collateral_amt):
                    continue
                ...
                for i in range(20):
                    ...
                    if execution_price < (1 + penalty) * (cdp.debt_amt / cdp.collateral_amt) or collat_sold == 0:  # trade amount too high
    ...
    return TradeStrategy(strategy, name='liquidate all')
