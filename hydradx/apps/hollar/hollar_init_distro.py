...
# col1, col2 = st.columns([1, 1])  # You can adjust column width ratio
# col1.subheader("Hollar Dumped")
# col2.subheader("Duration of Hollar dump")
# with col1:
#     default_values = [0] * 10
#     default_values[0] = 1000000
#     hollar_amounts_inputs = [0] * 10
#     for i in range(10):
#         hollar_amounts_inputs[i] = st.number_input(
#             "", min_value=0, value= default_values[i], step=1, key=f"sell_amt_{i}", label_visibility='hidden'
#         )
#
# with col2:
#     default_values = [0] * 10
#     default_values[0] = 1000000
#     hollar_dump_blocks_inputs = [0] * 10
#     for i in range(10):
#         hollar_dump_blocks_inputs[i] = st.number_input(
#             "", min_value=0, value= default_values[i], step=1, key=f"sell_blocks_{i}", label_visibility='hidden'
#         )
