...
bucket_size = bucketed_asset_fees[0]['end_block'] - bucketed_asset_fees[0]['start_block'] + 1
...
bucketed_asset_fees_values = [x['value'] for x in bucketed_asset_fees]
bucketed_hub_fees_values = [x['value'] for x in bucketed_hub_fees]
