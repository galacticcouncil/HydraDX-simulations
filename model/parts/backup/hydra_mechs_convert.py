...
# Not used yet, weight to share conversion during trades, need to be specified
def r_to_r_pool_reserve_one(params, substep, state_history, prev_state, policy_input):
    ...
    if delta_Ri == 0:
        ...
        pool.swap_share_pool(asset_id, delta_Wi) # adds share
        pool.swap_share_pool(purchased_asset_id, delta_Wk) # adds share
...
def r_to_q_pool_reserve_one(params, substep, state_history, prev_state, policy_input):
    ...
    if delta_Ri == 0:
        ...
        delta_Wi = delta_Wq
        pool.swap_share_pool(asset_id, delta_Wi)
