import numpy as np
import pandas as pd
from .hydra_utils import * # original mechanisms
# from .hydra_agent_utils import *
from .hydra_agent_utils_class import *
...
For a particular choice of 'CHANGE LOG' parameter it allows to test out different candidate mechanisms and their effects.
    ...
    if action == 'Ri_Purchase':
        if params['CHANGE_LOG'] == '3-25-21':
            return q_to_r_pool_discrete(params, substep, state_history, prev_state, policy_input)
        if params['CHANGE_LOG'] == '4-01-21':
            return q_to_r_pool_reserve_one(params, substep, state_history, prev_state, policy_input)
        else:
