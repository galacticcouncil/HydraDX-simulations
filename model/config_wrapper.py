...
class ConfigWrapper:
    ...
    def __init__(
        ...
        m_state_variables = importlib.import_module(f'{model.__name__}.state_variables').initial_state
        m_psubs = importlib.import_module(f'{model.__name__}.partial_state_update_block').partial_state_update_block
        m_params = importlib.import_module(f'{model.__name__}.sys_params').params
        ...
        print("m_state_variables", m_state_variables)
